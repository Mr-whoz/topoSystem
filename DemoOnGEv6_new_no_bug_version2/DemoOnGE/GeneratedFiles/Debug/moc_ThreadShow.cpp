/****************************************************************************
** Meta object code from reading C++ file 'ThreadShow.h'
**
...
#error "The header file 'ThreadShow.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_ThreadShow[] = {
    "ThreadShow\0"
};

const QMetaObject ThreadShow::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ThreadShow,
      qt_meta_data_ThreadShow, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ThreadShow))
